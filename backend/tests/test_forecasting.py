...
class TestForecastingModels(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.train_series, self.test_series_split = train_test_split_series(self.test_series)
    ...
    def test_train_test_split_series(self):
        ...
        for test_size in [5, 10, 15]:
            with self.subTest(test_size=test_size):
                train, test = train_test_split_series(self.test_series, test_size=test_size)

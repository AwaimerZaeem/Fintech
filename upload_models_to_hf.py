#!/usr/bin/env python3
"""
Upload FinTech DataGen ML Models to Hugging Face Hub
"""
...
# Import your models
from backend.ml_models.forecasting import (
...
class ModelUploader:
    def __init__(self, hf_token=None):
        ...
        self.username = "abdullah-daoud"  # Replace with your actual HF username
    ...
    def upload_traditional_models(self):
        ...
        # Create repository
        repo_name = f"{self.username}/fintech-traditional-forecasters"
        try:
    ...
    def upload_neural_models(self):
        ...
        # Create repository
        repo_name = f"{self.username}/fintech-neural-forecasters"
        try:
            create_repo(repo_name, exist_ok=True)
            print(f"✅ Created repository: {repo_name}")
        except Exception as e:
    ...
    def upload_ensemble_model(self):
        ...
        # Create repository
        repo_name = f"{self.username}/fintech-ensemble-forecaster"
        try:
            create_repo(repo_name, exist_ok=True)
            print(f"✅ Created repository: {repo_name}")
        except Exception as e:
...
def main():
    ...
    try:
        ...
        print(f"   - https://huggingface.co/{uploader.username}/fintech-traditional-forecasters")
        print(f"   - https://huggingface.co/{uploader.username}/fintech-neural-forecasters")
        print(f"   - https://huggingface.co/{uploader.username}/fintech-ensemble-forecaster")
